...
echo -e "\033[1;36m   Live Architecture & Autonomous AI Agent Demonstration         \033[0m"
echo -e "\033[1;36m=================================================================\033[0m"
echo ""
...
echo -e "\033[1;33m[4/5] Simulating DLQ Poison-Pill Ingestion & Autonomous AI Triage...\033[0m"
echo -e "\033[0;37m -> Injecting DLQ incident: High-value transaction (\$45,000.00) with corrupted creditor schema\033[0m"
echo -e "\033[1;36m -> [AI AGENT VERDICT] Incident: INCIDENT-8f12cb4a\033[0m"
